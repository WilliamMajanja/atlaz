...
export default function Sidebar() {
  ...
  return (
    <aside className="w-[220px] flex flex-col relative overflow-hidden shrink-0" style={{
      ...
      <div className="relative px-4 py-5 border-b" style={{ borderColor: "rgba(26, 37, 64, 0.5)" }}>
